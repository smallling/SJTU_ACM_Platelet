...
number _asin(number x){
  x = std::min(x,(number)1),x = std::max(x,
                                         (number)-1);
  return std::asin(x);
}
...
bool
seg_has_intersection(const line &a,const line &b){
  if(point_on_seg(a.a,b)||point_on_seg(a.b,b)||
     point_on_seg(b.a,a)||point_on_seg(b.b,a))
    return /* including endpoints */ true;
  return sgn(det(a.a-b.a,b.b-b.a))*
         sgn(det(a.b-b.a,b.b-b.a))<0&&
         sgn(det(b.a-a.a,a.b-a.a))*
         sgn(det(b.b-a.a,a.b-a.a))<0;
}
...
point
symmetry_point(const point &a,const point &o){
  return o+o-a;
}
...
bool
intersect(const line &l,const circle &a,point &p1,
          point &p2){
